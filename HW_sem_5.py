...
task = int(input(f"Введите номер задания: 26 и 28 - основные задания к семинару; \n101, 102, 103 и 104 (решение в одном задании) - дополнительные задания: "))
if task == 26:
...
if task == 103 or task == 104:
    print("Задача №103 и Задача №104")
